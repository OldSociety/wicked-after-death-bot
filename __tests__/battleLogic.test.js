...
describe('Character Traits', () => {
  ...
  describe('Battle Outcomes', () => {
    ...
    test('Character should beat harpy at least 80% of the battles against mockEnemy', () => {
      for (const character of characters) {
        ...
        for (let i = 0; i < totalBattles; i++) {
          ...
          mockEnemy.current_health = mockEnemy.effective_health

          while (character.current_health > 0 && mockEnemy.current_health > 0) {
            applyDamage(character, mockEnemy)
            applyDamage(mockEnemy, character)

            if (mockEnemy.current_health <= 0) {
